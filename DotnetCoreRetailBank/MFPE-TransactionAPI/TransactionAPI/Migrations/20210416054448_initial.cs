    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Counterparty_ID = table.Column<int>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Payment_Method_Code = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Payment_Method_Name = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Trans_Status_Code = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Trans_Status_Description = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Trans_Type_Code = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Trans_Type_Description = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Service_ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Date_Service_Provided = table.Column<DateTime>(nullable: false),
                    Other_Details = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Counterparty_ID = table.Column<int>(nullable: false),
                    Date_of_Transaction = table.Column<DateTime>(nullable: false),
                    Amount_of_Transaction = table.Column<double>(nullable: false),
                    Other_Details = table.Column<string>(nullable: true),
                    Payment_Method_Code = table.Column<int>(nullable: false),
                    Trans_Type_Code = table.Column<int>(nullable: false),
                    Trans_Status_Code = table.Column<int>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2021, 4, 16, 11, 14, 48, 361, DateTimeKind.Local).AddTicks(1388), "Other Details 1" },
                    { 1, new DateTime(2021, 4, 16, 11, 14, 48, 361, DateTimeKind.Local).AddTicks(103), "Other Details 1" },
                    { 3, new DateTime(2021, 4, 16, 11, 14, 48, 361, DateTimeKind.Local).AddTicks(1414), "Other Details 1" }
                });
