    ...
    class ControllerTester
    {
        ...
        private static IEnumerable<List<Customer>> GetAllCustomers_TestCase
        {
            get
            {
                ...
                new Customer{ Name="Abcdef",Address="abcdef",DOB=Convert.ToDateTime("1997-11-10"),PAN_Number="ABCDEF1234",Email="abcdef@gmail.com",Password
                ="abcdef",ConfirmPassword="abcdef"} ,
                new Customer{ Name="Ghijkl",Address="ghijkl",DOB=Convert.ToDateTime("1982-05-05"),PAN_Number="GHIJKL1234",Email="ghijkl@gmail.com",Password
        ...
        public void GetCustomerDetailsTest(int id, int expected)
        {
            mock.Setup(x => x.GetAllCustomers()).Returns(new List<Customer> {
                new Customer {CustomerId=1, Name = "Dhanshri", Address = "rtyuioasdfghjkl", DOB = Convert.ToDateTime("1998-02-01"), PAN_Number = "BRAKGK6468", Email = "nandedhanshri@gmail.com", Password = "qwertnio", ConfirmPassword = "qwertnio" },
                new Customer {CustomerId=2, Name = "Divya", Address = "zxcvbnqwertyu", DOB = Convert.ToDateTime("1999-02-01"), PAN_Number = "JKLMNO2345", Email = "divya@gmail.com", Password = "asdfghop", ConfirmPassword = "asdfgop" }
            });
            systemUnderTest = new CustomersController(mock.Object);
        ...
        public void CheckCustomerCredentialsTest()
        {
            ...
            Customer customer = new Customer { CustomerId = 1, Name = "Dhanshri", Address = "rtyuio", DOB = Convert.ToDateTime("1998-12-21"), PAN_Number = "BRAKGK6468", Email = "nandedhanshri@gmail.com", Password = "qwertn", ConfirmPassword = "qwertn" };
